...
public class ControllerClass{
	...
	public String editUnavailable(@ModelAttribute("table") Table table, Model model,
			HttpSession session, @RequestParam(required = true) int id) {
	...
	public String changeUnavailable(@ModelAttribute("table") Table table, Model model, @RequestParam("time") String time
			, @RequestParam("date") String date, @RequestParam("ReservationID") String reservationID, 
			@RequestParam("serverID") String serverID, @RequestParam("billID") String billID, 
			@RequestParam("isAvailable") boolean isAvailable) {
