...
<div class="container">
		...
		<form:form action="${pageContext.request.contextPath}/changePassword/" cssClass="form-horizontal"
		 method="post" modelAttribute="server">
			...
			<div>
				<label for="previousPass" class="col-md-3 controllabel">Previous Password: </label>
				<div>
			...
			<div>
				<label for="newPass" class="col-md-3 controllabel">New Password: </label>
				<div>
			...
			<div>
				<label for="confirmPass" class="col-md-3 controllabel">Confirm Password: </label>
				<div>
