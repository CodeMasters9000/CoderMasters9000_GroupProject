...
<body>
	<div class="container">
		...
		<a href="https://ibb.co/bPVh3vQ"><img
			src="https://i.ibb.co/47LyfSK/floor.png" alt="floor" border="0"></a>
		<hr>
				...
				<tbody>
					<c:forEach var="table" items="${availableTables}">
						<tr>
							...
							<td>${table.seats}</td>
							<td><a
								HREF="${pageContext.request.contextPath}/editTable/?id=${table.tableID}">Change
									Status</a></td>

							<form:form method="post" modelAttribute="table">
								<form:input name="tableID" path="tableID" type="hidden"
									value="${table.tableID}"></form:input>
							</form:form>
						</tr>
					</c:forEach>
				</tbody>
				...
				<tbody>
					<c:forEach var="table" items="${unavailableTables}">
						<tr>
							...
							<td><a
								HREF="${pageContext.request.contextPath}/editUnavailable/?id=${table.tableID}">Change
									Status</a></td>
						</tr>
					</c:forEach>
				</tbody>
